...
namespace ITSearch.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,sku,Description,ProductPrice,Inventoried,Inventory")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,sku,Description,ProductPrice,Inventoried,Inventory")] Product product)
        {
